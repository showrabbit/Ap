...
public class Ap_Net_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Ap.Net.ByteBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateAp_Net_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateAp_Net_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				Ap.Net.ByteBuffer obj = new Ap.Net.ByteBuffer();
