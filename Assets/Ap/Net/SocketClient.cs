...
namespace Ap.Net
{
    ...
    public class SocketClient
    {
        ...
        public delegate void OnConnectHandle(int protocal, ByteBuffer data);
        public delegate void OnDisconnectedHandle(int protocal, ByteBuffer data);
        public delegate void OnReceivedMessageHandle(int protocal, ByteBuffer data);

        public OnConnectHandle OnConnectEvent;
        public OnDisconnectedHandle OnDisconnectedEvent;
        public OnReceivedMessageHandle OnReceivedMessageEvent;
        ...
        void OnReceivedMessage(MemoryStream ms)
        {
            ...
            {
                OnReceivedMessageEvent(mainId, buffer);
            }
        }
