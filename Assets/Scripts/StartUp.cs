...
public class StartUp : MonoBehaviourEx
{
    ...
    IEnumerator Init()
    {
        ...
        // 是否初次加载游戏
        if (Ap.Core.ManagerManagers.Instance.IsFirstInited)
        {
        ...
        //ProtocolCtr.Init();
        Ap.Net.NetworkManager.Instance.OnReceivedMessage += NetworkManager_OnReceivedMessage;
        ...
        else
        {
            ...
            // 加载Lua 加载lua 
            // 加载地图
            FormManager.Instance.Show("MainForm");
